...
echo "Ajout SKU, META SEO et ajustement des stocks\n\n";
...
echo "✅ Optimisation META SEO complète (meta_title, meta_description, meta_keywords)\n";
echo "✅ Traductions FR/EN/NL pour tous les champs META\n";
