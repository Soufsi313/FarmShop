...
class OrderReturnController extends Controller
{
     ...
     *         in="query",
     *         description="Filtrer par statut d'inspection",
     *         @OA\Schema(type="string", enum={"pending", "inspecting", "completed", "failed"}, example="pending")
     *     ),
     *     @OA\Parameter(
     *         name="date_from",
     *         in="query",
     ...
     * )
     * 
     * Afficher les demandes de retour (Admin seulement)
     */
    public function adminIndex(Request $request)\Support\Facades\Storage;
