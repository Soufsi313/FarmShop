<?php
/**
 * Runner pour tous les tests Cart
 * 
 * Exécute tous les tests du système de panier
 */
...
echo "\n";
echo "╔════════════════════════════════════════════════════════════╗\n";
echo "║          FARMSHOP - TESTS UNITAIRES CART SYSTEM           ║\n";
echo "║                                                            ║\n";
echo "║  Exécution de tous les tests du système de panier         ║\n";
echo "╚════════════════════════════════════════════════════════════╝\n";
echo "\n";

$startTime = microtime(true);
$tests = [
    'Cart Model' => __DIR__ . '/test_cart_model.php',
    'CartItem Model' => __DIR__ . '/test_cart_item_model.php',
    'Cart Business Logic' => __DIR__ . '/test_cart_business_logic.php',
];
...
if ($failedCount === 0) {
    echo "🎉 TOUS LES TESTS CART SYSTEM ONT RÉUSSI ! 🎉\n";
} else {
