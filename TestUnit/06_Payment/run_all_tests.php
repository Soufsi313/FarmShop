<?php
/**
 * Runner pour tous les tests Payment
 * 
 * Exécute tous les tests du système de paiement
 */
...
echo "\n";
echo "╔════════════════════════════════════════════════════════════╗\n";
echo "║        FARMSHOP - TESTS UNITAIRES PAYMENT SYSTEM          ║\n";
echo "║                                                            ║\n";
echo "║  Exécution de tous les tests du système de paiement       ║\n";
echo "╚════════════════════════════════════════════════════════════╝\n";
echo "\n";

$startTime = microtime(true);
$tests = [
    'Stripe Service' => __DIR__ . '/test_stripe_service.php',
    'Payment Controller' => __DIR__ . '/test_payment_controller.php',
    'Payment Business Logic' => __DIR__ . '/test_payment_logic.php',
];
...
if ($failedCount === 0) {
    echo "🎉 TOUS LES TESTS PAYMENT SYSTEM ONT RÉUSSI ! 🎉\n";
} else {
