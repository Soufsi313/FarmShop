...
@section('title', 'Paiement confirmé - Commande #' . $order->order_number)
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="mt-1 text-sm text-green-700">
                        Votre commande #{{ $order->order_number }} a été traitée avec succès.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
            ...
            <div class="text-sm text-blue-800 space-y-2">
                ...
                <p>• Votre commande sera traitée dans les prochaines heures</p>
                <p>• Vous recevrez un email avec les informations de suivi dès l'expédition</p>
                <p>• La livraison est estimée sous 2-3 jours ouvrés</p>
            </div>
        </div>
