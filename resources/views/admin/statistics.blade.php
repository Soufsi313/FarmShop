...
@section('title', __('statistics.page_title'))
@section('page-title', __('statistics.page_subtitle'))
...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-5">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">{{ __('statistics.dashboard_title') }}</h1>
                <p class="text-gray-600 mt-1">{{ __('statistics.dashboard_description') }}</p>
            </div>
            <div class="mt-4 lg:mt-0 flex space-x-3">
                <select class="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500" id="periodFilter">
                    <option value="7">{{ __('statistics.filters.period_7_days') }}</option>
                    <option value="30" selected>{{ __('statistics.filters.period_30_days') }}</option>
                    <option value="90">{{ __('statistics.filters.period_3_months') }}</option>
                    <option value="365">{{ __('statistics.filters.period_year') }}</option>
                </select>
                <button class="px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-colors">
                    {{ __('statistics.filters.refresh_button') }}
                </button>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
        <h2 class="text-xl font-semibold text-gray-900 mb-4">📊 {{ __('statistics.analytics.title') }}</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div class="bg-blue-50 p-4 rounded-lg border border-blue-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-600">{{ __('statistics.analytics.unique_visitors') }}</p>
                        ...
                        <p class="text-xs text-blue-600">{{ $analyticsStats['growth_rate'] }} {{ __('statistics.analytics.vs_last_month') }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-green-50 p-4 rounded-lg border border-green-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-600">{{ __('statistics.analytics.page_views') }}</p>
                        ...
                        <p class="text-xs text-green-600">{{ $analyticsStats['bounce_rate'] }} {{ __('statistics.analytics.bounce_rate') }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-purple-50 p-4 rounded-lg border border-purple-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-600">{{ __('statistics.analytics.avg_session_duration') }}</p>
                        <p class="text-2xl font-bold text-gray-900">{{ $analyticsStats['avg_session_duration'] }}</p>
                        <p class="text-xs text-purple-600">{{ __('statistics.analytics.minutes') }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-orange-50 p-4 rounded-lg border border-orange-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-600">{{ __('statistics.ecommerce.conversion_rate') }}</p>
                        <p class="text-2xl font-bold text-gray-900">{{ $analyticsStats['conversion_rate'] }}</p>
                        <p class="text-xs text-orange-600">{{ __('statistics.ecommerce.conversion_rate') }}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Section Newsletter -->
    <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
        <h2 class="text-xl font-semibold text-gray-900 mb-4">📧 {{ __('statistics.newsletter.title') }}</h2>
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
            <div class="bg-indigo-50 p-4 rounded-lg border border-indigo-200">
                <div class="text-center">
                    ...
                    <p class="text-sm font-medium text-gray-600">{{ __('statistics.newsletter.total_subscribers') }}</p>
            ...
            <div class="bg-cyan-50 p-4 rounded-lg border border-cyan-200">
                <div class="text-center">
                    ...
                    <p class="text-sm font-medium text-gray-600">{{ __('statistics.newsletter.newsletters_sent') }}</p>
                    <p class="text-2xl font-bold text-gray-900">{{ $newsletterStats['sent_count'] }}</p>
                    <p class="text-xs text-cyan-600">{{ __('statistics.newsletter.this_month') }}</p>
                </div>
            </div>
            ...
            <div class="bg-emerald-50 p-4 rounded-lg border border-emerald-200">
                <div class="text-center">
                    ...
                    <p class="text-sm font-medium text-gray-600">{{ __('statistics.newsletter.open_rate') }}</p>
                    <p class="text-2xl font-bold text-gray-900">{{ $newsletterStats['open_rate'] }}%</p>
                    <p class="text-xs text-emerald-600">{{ __('statistics.newsletter.average') }}</p>
                </div>
            </div>
            ...
            <div class="bg-amber-50 p-4 rounded-lg border border-amber-200">
                <div class="text-center">
                    ...
                    <p class="text-sm font-medium text-gray-600">{{ __('statistics.newsletter.click_rate') }}</p>
                    <p class="text-2xl font-bold text-gray-900">{{ $newsletterStats['click_rate'] }}%</p>
                    <p class="text-xs text-amber-600">{{ __('statistics.newsletter.average') }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Section Locations -->
    <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
        <h2 class="text-xl font-semibold text-gray-900 mb-4">🏠 {{ __('statistics.rentals.title') }}</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div class="bg-teal-50 p-4 rounded-lg border border-teal-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-600">{{ __('statistics.products.categories') }}</p>
                        <p class="text-2xl font-bold text-gray-900">{{ $rentalStats['categories_count'] }}</p>
                        <p class="text-xs text-teal-600">{{ __('statistics.status.active') }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-rose-50 p-4 rounded-lg border border-rose-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-600">{{ __('statistics.rentals.active_rentals') }}</p>
                        <p class="text-2xl font-bold text-gray-900">{{ $rentalStats['active_rentals'] }}</p>
                        <p class="text-xs text-rose-600">{{ __('statistics.status.active') }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-violet-50 p-4 rounded-lg border border-violet-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-600">{{ __('statistics.rentals.rental_revenue') }}</p>
                        <p class="text-2xl font-bold text-gray-900">{{ $rentalStats['total_revenue'] }}€</p>
                        <p class="text-xs text-violet-600">{{ __('statistics.newsletter.this_month') }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-slate-50 p-4 rounded-lg border border-slate-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-600">{{ __('statistics.rentals.equipment_utilization') }}</p>
                        <p class="text-2xl font-bold text-gray-900">{{ $rentalStats['occupancy_rate'] }}%</p>
                        <p class="text-xs text-slate-600">{{ __('statistics.newsletter.average') }}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
            <h3 class="text-lg font-semibold text-gray-900 mb-4">📈 {{ __('statistics.charts.user_activity') }} ({{ __('statistics.filters.period_30_days') }})</h3>
            <div class="h-80">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
            <h3 class="text-lg font-semibold text-gray-900 mb-4">📧 {{ __('statistics.newsletter.title') }}</h3>
            <div class="h-80">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
            <h3 class="text-lg font-semibold text-gray-900 mb-4">🛒 {{ __('statistics.charts.orders_trends') }}</h3>
            <div class="h-80">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
            <h3 class="text-lg font-semibold text-gray-900 mb-4">💰 {{ __('statistics.charts.revenue_evolution') }}</h3>
            <div class="h-80">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 max-w-full">
        ...
        <div class="stat-card cursor-pointer" onclick="showDetailModal('visitors')" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
            ...
            <div class="flex-1">
                ...
                <div class="text-white/90 font-medium text-xs">{{ __('statistics.analytics.unique_visitors') }}</div>
                <div class="text-white/70 text-xs mt-1">+12.5% {{ __('statistics.ecommerce.vs_previous_period') }}</div>
            </div>
        </div>
        ...
        <div class="stat-card cursor-pointer" onclick="showDetailModal('products')" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);">
            ...
            <div class="flex-1">
                ...
                <div class="text-white/90 font-medium text-xs">{{ __('statistics.analytics.page_views') }} {{ __('statistics.products.products') }}</div>
                <div class="text-white/70 text-xs mt-1">+8.3% {{ __('statistics.ecommerce.vs_previous_period') }}</div>
            </div>
        </div>
        ...
        <div class="stat-card cursor-pointer" onclick="showDetailModal('blog')" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%);">
            ...
            <div class="flex-1">
                ...
                <div class="text-white/90 font-medium text-xs">{{ __('statistics.recent_activity.blog_views') }}</div>
                <div class="text-white/70 text-xs mt-1">+15.7% {{ __('statistics.ecommerce.vs_previous_period') }}</div>
            </div>
        </div>
        ...
        <div class="stat-card cursor-pointer" onclick="showDetailModal('interactions')" style="background: linear-gradient(135deg, #fa709a 0%, #fee140 100%);">
            ...
            <div class="flex-1">
                ...
                <div class="text-white/90 font-medium text-xs">{{ __('statistics.recent_activity.interactions') }}</div>
                <div class="text-white/70 text-xs mt-1">{{ __('statistics.recent_activity.product_likes_comments') }}</div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 max-w-full">
        ...
        <div class="chart-container">
            <h3 class="text-lg font-semibold text-gray-900 mb-3">{{ __('statistics.recent_activity.visitors_evolution') }}</h3>
        ...
        <div class="chart-container">
            <h3 class="text-lg font-semibold text-gray-900 mb-3">{{ __('statistics.charts.revenue') }} & {{ __('statistics.charts.orders') }}</h3>
            <div style="position: relative; height: 250px; width: 100%;">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 max-w-full">
        ...
        <div class="section-card">
            <h3 class="text-lg font-semibold text-gray-900 mb-4">{{ __('statistics.products.most_viewed') }}</h3>
            <div class="space-y-3">
                ...
                <div class="flex items-center space-x-4 p-3 rounded-lg bg-gray-50">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-sm text-gray-500">{{ $product['views'] }} {{ __('statistics.products.views') }}</p>
                    </div>
        ...
        <div class="section-card">
            <h3 class="text-lg font-semibold text-gray-900 mb-4">{{ __('statistics.products.most_read_articles') }}</h3>
            <div class="space-y-3 max-h-80 overflow-y-auto">
                ...
                <div class="flex items-center space-x-4 p-3 rounded-lg bg-gray-50">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-sm text-gray-500">{{ $article['views'] }} {{ __('statistics.products.reads') }}</p>
                    </div>
                    <div class="text-sm font-medium text-gray-900">
                        {{ $article['comments'] }} 💬
                    </div>
    ...
    <div class="chart-container max-w-full">
        <h3 class="text-lg font-semibold text-gray-900 mb-3">{{ __('statistics.recent_activity.interactions_breakdown') }}</h3>
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 max-w-full">
            <div style="position: relative; height: 250px; width: 100%;">
            ...
            <div class="flex flex-col justify-center space-y-3">
                <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    <div class="flex items-center space-x-2">
                        ...
                        <span class="font-medium text-sm">{{ __('statistics.recent_activity.product_likes') }}</span>
                    </div>
                ...
                <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    <div class="flex items-center space-x-2">
                        ...
                        <span class="font-medium text-sm">{{ __('statistics.recent_activity.blog_comments') }}</span>
                    </div>
                ...
                <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    <div class="flex items-center space-x-2">
                        ...
                        <span class="font-medium text-sm">{{ __('statistics.recent_activity.shares') }}</span>
                    </div>
