            ...
            <div class="bg-white p-6 rounded-lg shadow-sm">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">{{ $specialOffers->where('status', 'active')->count() }}</p>
                    </div>
                </div>
            </div>
            <div class="bg-white p-6 rounded-lg shadow-sm">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">
                            {{ $specialOffers->filter(function($offer) { 
                                return $offer->start_date <= now() && $offer->end_date >= now() && $offer->status === 'active'; 
                            })->count() }}
                        </p>
                    </div>
                </div>
            ...
            <div class="bg-white p-6 rounded-lg shadow-sm">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">{{ $specialOffers->where('status', 'inactive')->count() }}</p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="p-4">
                                ...
                                <div class="flex space-x-2">
                                    ...
                                    <form action="{{ route('admin.special-offers.toggle', $offer) }}" method="POST" class="flex-1">
                                        ...
                                        @method('PATCH')
                                        <button type="submit" 
                                                class="w-full {{ $offer->status === 'active' ? 'bg-yellow-100 text-yellow-700 hover:bg-yellow-200' : 'bg-green-100 text-green-700 hover:bg-green-200' }} py-2 px-3 rounded-lg transition-colors text-sm">
                                            @if($offer->status === 'active')
