...
<div id="process-modal-{{ $report->id }}" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden flex items-center justify-center z-50">
    <div class="bg-white rounded-lg p-6 max-w-md w-full m-4">
        ...
        <div class="mb-4 p-3 bg-red-50 rounded">
            ...
            @endif
            <small class="text-gray-600">Signalé par {{ $report->user->name ?? 'Utilisateur supprimé' }}</small>
        </div>

        <div class="flex flex-wrap gap-2">
            <!-- Modérer (approuver le signalement) -->
                            ...
                            <div class="mt-6">
                                ...
                                <div class="space-y-4">
                                        ...
                                        <div class="mt-4 space-y-3">
                                            <div class="flex items-start">
                                                ...
                                                <label for="resolveAction" class="ml-3 block text-sm text-gray-700">
                                                    <span class="font-medium text-green-600">🎯 Traiter le signalement</span>
                                                    <p class="text-gray-500 mt-1">Le signalement est fondé, prendre une action sur le commentaire</p>
                                                </label>
                                            </div>
                                            <div class="flex items-start">
                                                ...
                                                <label for="dismissAction" class="ml-3 block text-sm text-gray-700">
                                                    <span class="font-medium text-gray-600">❌ Rejeter le signalement</span>
                                                    <p class="text-gray-500 mt-1">Le signalement n'est pas fondé, aucune action requise</p>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="commentActionGroup" class="hidden border-l-4 border-blue-200 pl-4 ml-4">
                                        <label class="text-base font-medium text-blue-900">Action à effectuer sur le commentaire :</label>
                                        <div class="mt-4 space-y-3">
                                            <div class="flex items-start">
                                                ...
                                                <label for="deleteCommentAction" class="ml-3 block text-sm text-gray-700">
                                                    <span class="font-medium text-red-600">🗑️ Supprimer définitivement</span>
                                                    <p class="text-gray-500 mt-1">Le commentaire sera supprimé et n'apparaîtra plus</p>
                                                </label>
                                            </div>
                                            <div class="flex items-start">
                                                ...
                                                <label for="rejectCommentAction" class="ml-3 block text-sm text-gray-700">
                                                    <span class="font-medium text-orange-600">⚠️ Masquer le commentaire</span>
                                                    <p class="text-gray-500 mt-1">Le commentaire sera rejeté et masqué du public</p>
                                                </label>
                                            </div>
                                            <div class="flex items-start">
                                                ...
                                                <label for="keepCommentAction" class="ml-3 block text-sm text-gray-700">
                                                    <span class="font-medium text-green-600">✅ Garder le commentaire</span>
                                                    <p class="text-gray-500 mt-1">Le signalement était erroné, le commentaire reste visible</p>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
...
// Fonction simplifiée pour valider le formulaire avant soumission
function validateForm() {
    const action = document.querySelector('input[name="action"]:checked')?.value;
    
    if (!action) {
        alert('Veuillez sélectionner une action pour le signalement');
        return false;
    }
    ...
    if (action === 'resolve') {
        ...
        if (!commentAction) {
            alert('Veuillez sélectionner une action pour le commentaire');
            return false;
        }
    }
...
function toggleCommentActionGroup(show) {
    ...
    if (show) {
        ...
        commentActionGroup.classList.add('hidden');
        // Réinitialiser les choix d'action sur le commentaire
