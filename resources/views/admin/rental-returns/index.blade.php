                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex gap-2">
                                <!-- Bouton Voir - Amélioration: Plus grand et avec arrière-plan -->
                                <a href="{{ route('admin.rental-returns.show', $orderLocation) }}" 
                                   class="inline-flex items-center justify-center w-10 h-10 bg-blue-100 text-blue-600 rounded-lg hover:bg-blue-200 hover:text-blue-800 transition-all duration-200 shadow-sm hover:shadow-md"
                                ...
                                <form action="{{ route('admin.rental-returns.mark-returned', $orderLocation) }}" method="POST" class="inline">
                                    @csrf
                                    @method('PATCH')
                                    <!-- Bouton Confirmer retour - Amélioration: Plus grand et avec arrière-plan vert -->
                                    <button type="submit" class="inline-flex items-center justify-center w-10 h-10 bg-green-100 text-green-600 rounded-lg hover:bg-green-200 hover:text-green-800 transition-all duration-200 shadow-sm hover:shadow-md"
                                ...
                                <form action="{{ route('admin.rental-returns.start-inspection', $orderLocation) }}" method="POST" class="inline">
                                    @csrf
                                    @method('PATCH')
                                    <!-- Bouton Commencer inspection - Amélioration: Plus grand et avec arrière-plan violet -->
                                    <button type="submit" class="inline-flex items-center justify-center w-10 h-10 bg-purple-100 text-purple-600 rounded-lg hover:bg-purple-200 hover:text-purple-800 transition-all duration-200 shadow-sm hover:shadow-md"
