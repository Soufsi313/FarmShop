...
function createFichier1Step2()
{
    $phpWord = new PhpWord();
    $phpWord->getDocInfo()->setCreator('Soufiane MEFTAH');
    $phpWord->getDocInfo()->setTitle('FarmShop - Partie 1 - Step2');
    $phpWord->setDefaultFontName('Inter');
    $phpWord->setDefaultFontSize(12);

    // reintroduce title styles
...
function main()
{
    $out = '01_intro_presentation_step2.docx';
    echo "Generation step2...\n";
    $phpWord = createFichier1Step2();
